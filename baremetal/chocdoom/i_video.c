...
#define GFX_RGB565(r, g, b)			((((b & 0xF8) >> 3) << 11) | (((g & 0xFC) >> 2) << 5) | ((r & 0xF8) >> 3))

#define GFX_RGB565_B(color)			((0xF800 & color) >> 11)
#define GFX_RGB565_G(color)			((0x07E0 & color) >> 5)
#define GFX_RGB565_R(color)			(0x001F & color)

extern uint16_t lcd_fb[];
#define GFX_MAX_WIDTH 480
...
//	lcd_vsync = false;
	...
	for (y = 0; y < SCREENHEIGHT; y++)
	{
		for (x = 0; x < SCREENWIDTH; x++)
		{
			...
			lcd_fb[(272 - y - 1 - 36) * 480 + (480 - x - 1 - 80)] = rgb565_palette[index];
		}
	}
