...
char *sprnames[] __attribute__((section(".data.dram"))) = {
...
state_t	states[NUMSTATES] __attribute__((section(".data.dram"))) = {
...
mobjinfo_t mobjinfo[NUMMOBJTYPES] __attribute__((section(".data.dram"))) = {
