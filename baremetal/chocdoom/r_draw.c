...
int		viewwindowx;
int		viewwindowy; 
byte*		ylookup[MAXHEIGHT] __attribute__((section(".dram"))); 
int		columnofs[MAXWIDTH] __attribute__((section(".dram"))); 

// Color tables for different players,
//  translate a limited part to another
//  (color ramps used for  suit colors).
//
byte		translations[3][256] __attribute__((section(".dram")));	
...
int	fuzzoffset[FUZZTABLE] __attribute__((section(".dram"))) =
{
